...
//   return (
//     <nav className="bg-gray-800 bg-opacity-90 text-white p-4 sticky top-0 z-50 backdrop-blur-md">
...
//                 className="btn btn-sm btn-outline text-white hover:bg-red-600"
//               >
//                 Logout
//               </button>
//             </div>
//           ) : (
//             // Before Login: Login & Register Links
//             <>
